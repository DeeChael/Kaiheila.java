...
public class ExitedGuildEvent extends AbstractEvent {

    public static final String _AcceptType = "exited_guild";

    private final String userId;
    private final LocalDateTime exitedAt;

    public ExitedGuildEvent(Gateway gateway, JsonNode node) {
        super(gateway, node);
