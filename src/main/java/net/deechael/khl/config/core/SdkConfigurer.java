...
package net.deechael.khl.config.core;

import net.deechael.khl.api.Bot;
import net.deechael.khl.RabbitBuilder;
import net.deechael.khl.config.AbstractConfigurer;

public class SdkConfigurer extends AbstractConfigurer<RabbitBuilder, Bot> {

    public SdkConfigurer(RabbitBuilder rabbitBuilder) {
        super(rabbitBuilder);
    }
