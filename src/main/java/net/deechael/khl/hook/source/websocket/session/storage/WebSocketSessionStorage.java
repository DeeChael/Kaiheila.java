...
public interface WebSocketSessionStorage {
    ...
    WebSocketSessionStorage DEFAULT_SESSION_STORAGE = new WebSocketSessionFileBaseStorage(new File("./session.dat"));

    boolean saveSession(WebSocketEventSourceSession session);
